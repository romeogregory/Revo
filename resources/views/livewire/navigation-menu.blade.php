            ...
            <div class="d-flex align-items-stretch" id="kt_header_nav">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                        ...
                        @if (session()->get('mode') == 'administrator')
                            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                class="menu-item @if (request()->route()->getPrefix('managment')) here show @endif menu-lg-down-accordion me-lg-1">
                                <span class="menu-link py-3">
                                    <span class="menu-title">Managment</span>
                                    <span class="menu-arrow d-lg-none"></span>
                                </span>
                                <div
                                    class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                    <div class="menu-item">
                                        <a class="menu-link @if (request()->routeIs('managment.packages')) active @endif py-3"
                                            href="{{ route('managment.packages') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        @endif
                        @if (session()->get('mode') == 'moderator')
                            {{ session('mode') }}
                        @endif
                        @if (session()->get('mode') == 'support')
                            {{ session('mode') }}
                        @endif
                        @if (session()->missing('mode'))
                            <div class="menu-item menu-lg-down-accordion me-lg-1">
                                <a class="menu-link @if (request()->routeIs('dashboard')) active @endif py-3" href="{{ route('dashboard') }}">
                                    <span class="menu-title">Dashboard</span>
                                </a>
                            </div>
                            <div class="menu-item menu-lg-down-accordion me-lg-1">
                                <a class="menu-link @if (request()->routeIs('shop')) active @endif py-3" href="{{ route('shop') }}">
