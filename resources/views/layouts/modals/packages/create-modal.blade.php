<div wire:ignore.self class="modal fade" id="packageStoreModal" data-bs-keyboard="false" data-bs-backdrop="static"
    tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <form class="form">
                <div class="modal-header">
                    <h2 class="fw-bolder">Add a Package</h2>
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div wire:ignore.self class="scroll-y me-n7 pe-7" data-kt-scroll="true"
                        ...
                        <div class="fw-bolder fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                            href="#billing_information" role="button" aria-expanded="false"
                        ...
                        <div id="billing_information" class="collapse show">
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button wire:click.prevent="storePackageData()" wire:loading.attr="disabled" type="button"
